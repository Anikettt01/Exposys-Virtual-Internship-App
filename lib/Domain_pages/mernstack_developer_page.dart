...
class MernStackDeveloper extends StatefulWidget {
  const MernStackDeveloper({super.key});

  @override
  State<MernStackDeveloper> createState() => _MernStackDeveloperState();
}

class _MernStackDeveloperState extends State<MernStackDeveloper> {
  @override
            ...
            children: [
               Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(
                              "images/mean_stack_developer_background.jpg"
                          ),
                          fit: BoxFit.cover
                      )
                  ),
              ...
              Padding(
                ...
                child: Container(
                  height: h*0.1,
                  width: w,
                  child: Text("Mern Stack Developer",style: TextStyle(
                      color: Colors.black,
                      fontSize: 40,
              ...
              Padding(
                ...
                child: Container(
                  height: h*0.18,
                  width: w,
                  child: Text("➤  A recipe sharing platform where users can browse"
                      ", post, and search for recipes. The application could include user profiles"
                      ", recipe categorization, and a rating system. ",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 20,
