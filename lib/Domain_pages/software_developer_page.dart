...
class SoftwareDeveloper extends StatefulWidget {
  const SoftwareDeveloper({super.key});

  @override
  State<SoftwareDeveloper> createState() => _SoftwareDeveloperState();
}

class _SoftwareDeveloperState extends State<SoftwareDeveloper> {
  @override
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                            "images/Software_developer_background.jpg"
                        ),
                        fit: BoxFit.cover
                    )
                ),
              ...
              Padding(
                ...
                child: Container(
                  height: h*0.12,
                  width: w,
                  child: Text("➤  Build an E-learning web application platform.",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 20,
