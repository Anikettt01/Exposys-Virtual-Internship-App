...
class IOTDeveloper extends StatefulWidget {
  const IOTDeveloper({super.key});

  @override
  State<IOTDeveloper> createState() => _IOTDeveloperState();
}

class _IOTDeveloperState extends State<IOTDeveloper> {
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  height: h*0.1,
                  width: w,
                  child: Text("IOT",style: TextStyle(
                      color: Colors.black,
                      fontSize: 40,
              ...
              Padding(
                ...
                child: Container(
                  height: h*0.15,
                  width: w,
                  child: Text("➤  Develop Intelligent Traffic information System based on Internet of things ",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 20,
